 ...
 */
agentsStates: { [key in string]?: CollabAgentState }, } | { "type": "webSearch", id: string, query: string, action: WebSearchAction | null, } | { "type": "imageView", id: string, path: AbsolutePathBuf, } | { "type": "imageGeneration", id: string, status: string, revisedPrompt: string | null, result: string, savedPath?: AbsolutePathBuf, } | { "type": "loopLifecycle", id: string, kind: LoopLifecycleKind, title: string, summary: string, detail?: string, status: LoopLifecycleStatus, reason?: string, counts?: { [key in string]?: bigint }, error?: string, durationMs?: bigint, targetProfile?: string, } | { "type": "enteredReviewMode", id: string, review: string, } | { "type": "exitedReviewMode", id: string, review: string, } | { "type": "contextCompaction", id: string, };
