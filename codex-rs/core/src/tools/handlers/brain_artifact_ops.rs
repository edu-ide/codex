...
use crate::tools::handlers::brain_artifact_ops_spec::{
    BRAIN_ARTIFACT_OPS_TOOL_NAME, create_brain_artifact_ops_tool,
};
...
impl BrainArtifactOpsHandler {
    async fn handle_call(
        ...
        let output =
            tokio::task::spawn_blocking(move || execute_artifact_ops(service.as_ref(), req))
                .await
