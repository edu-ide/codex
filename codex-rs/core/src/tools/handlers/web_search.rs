        ...
        let (searxng_url, fallback, engine) = match &self.config {
            Some(cfg) => {
                let engine = match cfg.engine {
                    Some(codex_protocol::config_types::WebSearchEngine::Searxng) => {
                        web_search_rs::WebSearchEngine::Searxng
                    }
                    Some(codex_protocol::config_types::WebSearchEngine::Duckduckgo) => {
                        web_search_rs::WebSearchEngine::Duckduckgo
                    }
