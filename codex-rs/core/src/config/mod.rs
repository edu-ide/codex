...
pub struct Config {
    ...
    pub superloop: Option<codex_config::config_toml::SuperloopProfileToml>,
...
fn resolve_superloop_config(
    config_toml: &ConfigToml,
) -> Option<codex_config::config_toml::SuperloopProfileToml> {
    let superloop = config_toml.superloop.as_ref()?;
    let resolved = superloop.inline_profile();
