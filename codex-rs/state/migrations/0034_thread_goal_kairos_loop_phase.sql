...
CREATE TABLE thread_goals_new (
    ...
    loop_phase TEXT CHECK(loop_phase IN ('knowledge_loop', 'kairos_loop', 'super_loop', 'improvement_loop', 'cleanup_loop', 'execution_loop', 'context_injection')),
...
CREATE TABLE thread_goal_loop_history (
    ...
    phase TEXT NOT NULL CHECK(phase IN ('knowledge_loop', 'kairos_loop', 'super_loop', 'improvement_loop', 'cleanup_loop', 'execution_loop', 'context_injection')),
